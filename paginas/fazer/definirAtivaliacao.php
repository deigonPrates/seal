    ...
    <div class="col-sm-12">
        <div class="card-box">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/fazer/definirAtivaliacao">Avaliação</a>
                        </li>
                    </ol>
                </div>
            </div>
            <div class="row">
                ...
                <center><h4 class="page-title">Definindo Avaliação</h4></center>
                <br>
                <br>

                <form action="/definindo/avaliacao" class="form-horizontal" role="form" method="post">                                    
